...
import pickle
import copy
from src.rl.model import ActorNetwork2, REINFORCE_Network
import mpltex
import time
...
class Simulator:
    ...
    state_threshold, exploit_threshold, run_ID, epsilon = 10**(-100), fp_rate = [0,0,0,0,0,0,0,0], actor_network ='', untrained_actor_network =''):
        ...
        self.actor_network_dict['training'] = REINFORCE_Network(self.observation_space_size, self.action_space, 32)
    ...
    def reset(self, seed=None, options=None):
        ...
        self.defender       = self.classDefender(self.ids, self.graph, self.choicePath, self.successPath, self.policy, self.epsilon, seed,
                                            ...
                                            actor_network_dict = self.actor_network_dict, testDefense = self.testDefenses, omega = self.confidence,
